 ...
 * output. The only exception is for a Coinbase transaction, that adds new
 * coins to cirulation.
 *
 ...
 * @sig:		Signature. Prevents anyone from altering the content of
 *			the transaction. The transaction input is signed by the
 *			receiver of the referenced transaction output, using
 *			their private key
 */
